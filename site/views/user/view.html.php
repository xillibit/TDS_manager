 ...
 * @since 1.6
 */
class GesttaxesejourViewUser extends JView {
  /**
	 * Display the view
	 *
    ...
    $this->userProfile = new stdClass();
		...
		if ( $layout == 'edit' ) {
      $this->document->setTitle(JText::_('COM_GESTTAXESEJOUR_GESTION_TAXE_SEJOUR').' - '.JText::_('COM_GESTTAXESEJOUR_USER_EDITION_PROFIL'));
    } else {
      $this->document->setTitle(JText::_('COM_GESTTAXESEJOUR_GESTION_TAXE_SEJOUR').' - '.JText::_('COM_GESTTAXESEJOUR_USER_GESTION_PROFIL'));
    }     
