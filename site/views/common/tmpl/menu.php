  ...
  <ul style="display: inline;">
    ...
    <li style="display: inline; list-style: none;margin: 45px">
      <a href="<?php echo JRoute::_ ('index.php?com_tdsmanager&view=user') ?>">
        <img src="<?php echo JURI::root().'administrator/components/com_tdsmanager/media/icons/large/users.png' ?>" alt="<?php echo JText::_('COM_TDSMANAGER_CONTROL_PANEL_MANAGE_PROFILE') ?>" title="<?php echo JText::_('COM_TDSMANAGER_CONTROL_PANEL_MANAGE_PROFILE') ?>" />
      </a>
    </li>
  </ul>
</div>
