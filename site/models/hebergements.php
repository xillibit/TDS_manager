 ...
 * @since		1.6
 */
class GesttaxesejourModelHebergements extends JModel {
	/**
    ...
    // Get the parent id if defined.
		...
		$this->setState('com_gesttaxesejour.hosting.Id', $Hosting_Id);
    ...
    if ( $user->id > 0 ) {                  
      $query = "SELECT hosting.*, class.description AS classement_name FROM #__gesttaxesejour_hebergements AS hosting
                LEFT JOIN #__gesttaxesejour_classements AS class ON class.id=hosting.id_classement
      ...
      $this->setState('com_gesttaxesejour.hosting.total', count($hostings_list));
  ...
  public function getLabelList()	{
    ...
    $label_list = array();
    $label_list[] = JHTML::_ ( 'select.option', 0, JText::_('COM_GESTTAXESEJOUR_HEBERGEMENT_LABEL_NONE') ); 
