      ...
      <tr class="thisform">
        <td width="100%" valign="top" class="thisform">
          <div id="cpanel">
            ...
            <div class="icon-container">
            <div class="icon"> <a href="<?php echo JURI::root().'administrator/index.php?option=com_tdsmanager&view=declarations' ?>" title="<?php echo JText::_('COM_TDSMANAGER_CONTROLPANEL_DECLARATIONS');?>"> <img src="<?php echo JURI::base(true); ?>/components/com_tdsmanager/media/icons/large/declarations.png" align="middle" border="0" alt="" /> <span> <?php echo JText::_('COM_TDSMANAGER_CONTROLPANEL_DECLARATIONS'); ?> </span></a> </div>
            </div>
            <div class="icon-container">
              <div class="icon"> <a href="<?php echo JURI::root().'administrator/index.php?option=com_tdsmanager&view=reglements' ?>" title="<?php echo JText::_('COM_TDSMANAGER_CONTROLPANEL_REGLEMENTS');?>"> <img src="<?php echo JURI::base(true); ?>/components/com_tdsmanager/media/icons/large/reglements.png" align="middle" border="0" alt="" /> <span> <?php echo JText::_('COM_TDSMANAGER_CONTROLPANEL_REGLEMENTS'); ?> </span> </a> </div>
            </div>
            <div class="icon-container">
              <div class="icon"> <a href="<?php echo JURI::root().'administrator/index.php?option=com_tdsmanager&view=users' ?>" title="<?php echo JText::_('COM_TDSMANAGER_CONTROLPANEL_OWNERS');?>"> <img src="<?php echo JURI::base(true); ?>/components/com_tdsmanager/media/icons/large/users.png" align="middle" border="0" alt="" /> <span> <?php echo JText::_('COM_TDSMANAGER_CONTROLPANEL_OWNERS'); ?> </span></a> </div>
            </div>
          </div>
        </td>
      </tr>
