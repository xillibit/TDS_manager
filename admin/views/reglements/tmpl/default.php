...
<form action="<?php echo JRoute::_('index.php?option=com_tdsmanager&view=reglements'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
        ...
        <th width="10%" class="nowrap">
				...
				<th width="10%" class="nowrap">
					<?php echo JText::_('COM_TDSMANAGER_REGLEMENT_STATUS'); ?>
				</th>
        <th width="10%" class="nowrap">
					<?php echo JText::_('COM_TDSMANAGER_REGLEMENT_DECLARATION_DATE'); ?>
				</th>
				<th width="5%">
        ...
        <td>
					<?php echo !empty($item->numero_agrement) ? $item->numero_agrement : JText::_('COM_TDSMANAGER_NO_CLASSEMENT_DEFINED'); ?>
				</td>
				<td class="center">
