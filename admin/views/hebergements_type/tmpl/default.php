...
<form action="<?php echo JRoute::_('index.php?option=com_tdsmanager&view=hebergements_type'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="10%" class="nowrap">
					<?php echo JHtml::_('grid.sort', 'COM_TDSMANAGER_HEBRGEMENT_TYPE_NAME', 'name', $listDirn, $listOrder); ?>
				</th>
        <th width="10%" class="nowrap">
					<?php echo JHtml::_('grid.sort',  'COM_TDSMANAGER_HEBRGEMENT_TYPE_DESCRIPTION', 'description', $listDirn, $listOrder); ?>
				</th>
				<th width="10%" class="nowrap">
					<?php echo JText::_('COM_TDSMANAGER_HEBERGEMENT_STATUS'); ?>
				</th>
			</tr>
		</thead>
		<tfoot>
		...
		<tbody>
		<?php if ( !empty($this->list_hebergements) ):
		 foreach ($this->list_hebergements as $i => $item) : ?>
