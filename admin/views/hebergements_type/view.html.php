...
class TdsmanagerAdminViewHebergements_type extends TdsmanagerView {
  /**
    ...
    // TODO: remplacer banners.png par une icône propre à l'application
		JToolBarHelper::title(JText::_('COM_TDSMANAGER_HEBERGEMENTS_TYPE'), 'hebergement_types.png');
	}
	...
	protected function setToolbarCreate() {
	 // TODO: remplacer banners.png par une icône propre à l'application
		JToolBarHelper::title(JText::_('COM_TDSMANAGER_CREATE_HERBERGEMENT_TYPE'), 'hebergement_types.png');
		//JToolBarHelper::title(JText::_('COM_TDSMANAGER_EDIT_HERBERGEMENT_TYPE'), 'banners.png');
  ...
  protected function setToolbarEdit() {
	 // TODO: remplacer banners.png par une icône propre à l'application
		JToolBarHelper::title(JText::_('COM_TDSMANAGER_EDIT_HERBERGEMENT_TYPE'), 'hebergement_types.png');
		//JToolBarHelper::title(JText::_('COM_TDSMANAGER_EDIT_HERBERGEMENT_TYPE'), 'banners.png');
		JToolBarHelper::save('save');
		JToolBarHelper::cancel();
	}
