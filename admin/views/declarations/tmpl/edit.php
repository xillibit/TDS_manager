...
<div id="kadmin">
	<div class="kadmin-right">
		<form action="<?php echo JRoute::_('index.php?option=com_tdsmanager&view=declarations') ?>" method="post" id="adminForm" name="adminForm">
          ...
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_DECLARATION_PERSONNES_EXONEREES'); ?></td>
						<td>
          ...
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_DECLARATION_PERSONNES_REDUCTION'); ?></td>
						<td>
          ...
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_DECLARATION_PERSONNES_ASSUJETTIES'); ?></td>
						<td>
          ...
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_DECLARATION_PERSONNES_PERIODE'); ?></td>
						<td>
          ...
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_DECLARATION_DUREE_SEJOUR'); ?></td>
						<td>
							<input name="duree_sejour" value="<?php echo isset($this->declaration->duree_sejour) ? $this->declaration->duree_sejour :'' ?>" />
						</td>
					</tr>
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_DECLARATION_TOTAL_NUITEE'); ?></td>
						<td>
							<input name="nb_total_nuitee" value="<?php echo isset($this->declaration->nb_total_nuitee) ? $this->declaration->nb_total_nuitee :'' ?>" />
						</td>
					</tr>
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_DECLARATION_TARIF_NUIT'); ?></td>
						<td>
							<?php echo $this->list_tarifs_nuit; ?>
						</td>
					</tr>
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_DECLARATION_MONTANT_ENCAISSE_JOUR'); ?></td>
						<td>
