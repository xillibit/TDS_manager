	...
	<div class="kadmin-right">
		<form action="<?php echo JRoute::_('index.php?option=com_tdsmanager&view=hebergements') ?>" method="post" id="adminForm" name="adminForm">
				<table class="kadmin-adminform">
					<tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_HOSTINGNAME'); ?></td>
						<td>
          ...
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_DESCRIPTION'); ?></td>
						<td>
          ...
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_ADRESS'); ?></td>
						<td>
							<input name="adress" value="<?php if(!empty($this->hebergement->adress)) echo $this->hebergement->adress; ?>" />
						</td>
					</tr>
					<tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_COMPLEMENT_ADRESS'); ?></td>
						<td>
          ...
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_DATE_CLASSEMENT'); ?></td>
						<td>
          ...
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_HEBERGEMENT_LABEL'); ?></td>
						<td>
						  <?php echo $this->labellist; ?>
						</td>
					</tr>
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_HEBERGEMENT_TYPE'); ?></td>
						<td>
						  <?php echo $this->hebergement_typelist; ?>
						</td>
					</tr>
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_HEBERGEMENT_OWNER_NAME'); ?></td>
						<td>
						  <?php echo $this->users_list; ?>
						</td>
					</tr>
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_CAPACITE_CHAMBRES'); ?></td>
						<td>
          ...
          <tr>
						<td valign="top"><?php echo JText::_('COM_TDSMANAGER_CAPACITE_PERSONNES'); ?></td>
						<td>
