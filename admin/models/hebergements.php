...
class TdsmanagerAdminModelHebergements extends TdsmanagerModel {	
    ...
    $query = "SELECT COUNT(*) FROM #__gesttaxesejour_hebergements AS hosting";
    ...
    $query = "SELECT hosting.id AS hosting_id,hosting.*, class.description AS class_desc, hosting_type.name AS hosting_type_name, label.nom AS label_nom FROM #__gesttaxesejour_hebergements AS hosting
              LEFT JOIN #__gesttaxesejour_hebergclass AS hclass ON hosting.id=hclass.id_hebergement
              LEFT JOIN #__gesttaxesejour_classements AS class ON class.id=hclass.id_classement 
              LEFT JOIN #__gesttaxesejour_hebergements_type AS hosting_type ON hosting_type.id=hosting.id_hebergement_type
              LEFT JOIN #__gesttaxesejour_hebergements_label AS label ON label.id=hosting.id_hebergement_label".$search_value;
  ...
  public function getHebergement() {     
    ...
    $db = JFactory::getDBO();
    $query = "SELECT * FROM #__gesttaxesejour_hebergements WHERE id={$db->quote($id)}";
    $db->setQuery((string)$query);
  ...
  public function getListClassement() {
    ...
    $db = JFactory::getDBO();
    $query = "SELECT * FROM #__gesttaxesejour_classements WHERE state=1";
    $db->setQuery((string)$query);
