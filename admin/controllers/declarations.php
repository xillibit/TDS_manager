...
class TdsmanagerAdminControllerDeclarations extends TdsmanagerController {
  /**
    ...
    if ( !empty($ids) ) {    
      ...
      $this->setRedirect('index.php?option=com_gesttaxesejour&view=declarations&layout=edit');
    } else {
  ...
  public function create() {        
    $this->setRedirect('index.php?option=com_gesttaxesejour&view=declarations&layout=create');
  }
  ...
  public function save_first_part() {
    ...
    if ( $tarif_hebergement != '0.00' ) {*/            
      ...
      $this->setRedirect('index.php?option=com_gesttaxesejour&view=declarations&layout=detail');  
    /*} else {
