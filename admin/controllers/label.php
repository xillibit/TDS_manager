...
class TdsmanagerAdminControllerLabel extends TdsmanagerController {
  /**
    ...
    $this->app->setUserState( "com_gesttaxesejour.hebergement_label.id", $id );	
		...
		$this->setRedirect('index.php?option=com_gesttaxesejour&view=label&layout=create');
  }
  ...
  public function remove() {
    ...
    $query = "DELETE FROM #__gesttaxesejour_hebergements_label WHERE id={$db->quote($id)}";
  ...
  public function save() {
    ...
    if ( !$id ) {
      $query = "INSERT INTO #__gesttaxesejour_hebergements_label 
                (nom) 
       ...
       $this->app->redirect($this->baseurl); 
        ...
        $query = "UPDATE #__gesttaxesejour_hebergements_label 
